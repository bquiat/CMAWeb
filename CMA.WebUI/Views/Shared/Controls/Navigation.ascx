                ...
                <ul role="menu" class="dropdown-menu">
                    <li class="dropdown">
                        ...
                        <ul role="menu" class="dropdown-submenu">
                            ...
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="svcs" data-container-name="services" data-container-caption="Services">Services</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="et" data-container-name="service-type" data-container-caption="Service Type">Service Type</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="trel" data-container-name="term-relation" data-container-caption="Term Relation">Term Relation</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul role="menu" class="dropdown-submenu">
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="act" data-container-name="activity-type" data-container-caption="Activity Type">Activity Type</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="asse" data-container-name="assesment-type" data-container-caption="Assesment Type">Assesment Type</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="lang" data-container-name="language" data-container-caption="Language">Language</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="name" data-container-name="name-type" data-container-caption="Name Type">Name Type</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="nt" data-container-name="note-type" data-container-caption="Note Type">Note Type</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="pyrt" data-container-name="payor-type" data-container-caption="Payor Type">Payor Type</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="phon" data-container-name="phon-type" data-container-caption="Phone Type">Phone Type</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="decl" data-container-name="plan-item-type" data-container-caption="Plan Item Type">Plan Item Type</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="reg" data-container-name="region" data-container-caption="Region">Region</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="serv" data-container-name="resource-services" data-container-caption="Resource Services">Resource Services</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="st" data-container-name="states" data-container-caption="States">States</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="gt" data-container-name="user-group" data-container-caption="User Group">User Group</a>
                            </li>
                            <li>
                                <a class="menu-item" href="#" data-type="list" data-table="codes" data-query="uact" data-container-name="work-activity" data-container-caption="Work Activity">Work Activity</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
